 ...
 * 
 */
class TableFilterText extends TableFilter {

    public TableFilterText(final Table table, final String label, final String tooltip, final String name, final String value) {
        super(table, label, tooltip, name, value);
    }

    public TableFilterText(final Table table, final String label, final String tooltip, final String name) {
        super(table, label, tooltip, name);
    }
